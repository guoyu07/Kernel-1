...
class CoroutineRedisProxy
{
    ...
    public function evalMock($context, string $script, array $args = array(), int $numKeys = 0)
    {
        ...
        if (Server::getInstance()->processType == Marco::PROCESS_TASKER) {//task进程
    ...
    public function __call(string $name, array $arguments)
    {
        ...
        switch (strtolower($name)) {
            ...
            case 'setnx':
                ...
                if (isset($arguments[3]) && is_int($arguments[3]) && Server::getInstance()->processType == Marco::PROCESS_WORKER) {
